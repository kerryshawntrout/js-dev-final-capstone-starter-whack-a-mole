...
//added to allow the player to pick the level of difficulty
document.addEventListener("click", function(event) {
  if (event.target.matches("#easy")) {
    setDifficulty("easy");
  } else if (event.target.matches("#normal")) {
...
//toggleVisibility(chooseHole(holes))
/**
*
...
function startGame(){
  ...
  music.play(); //added to play the mole song once you click the start button
  setEventListeners();
  clearScore();
  setDuration(10);
  showUp();
